...
def main():
    ...
    # Determine hf_model_config_path: prefer 'huggingface' subdirectory if it exists
    hf_config_path = args.local_dir
    hf_subdir = os.path.join(args.local_dir, "huggingface")
    if os.path.isdir(hf_subdir) and os.path.exists(os.path.join(hf_subdir, "config.json")):
        hf_config_path = hf_subdir
