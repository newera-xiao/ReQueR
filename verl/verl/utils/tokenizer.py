...
def _wrap_apply_chat_template_disable_thinking(obj):
    """Wrap apply_chat_template to default enable_thinking=False."""
    if obj is None or not hasattr(obj, "apply_chat_template"):
        return obj
    if getattr(obj, "_verl_disable_thinking_wrapped", False):
        return obj
    ...
    obj.apply_chat_template = types.MethodType(wrapped, obj)
    setattr(obj, "_verl_disable_thinking_wrapped", True)
    return obj
...
def hf_tokenizer(name_or_path, correct_pad_token=True, correct_gemma2=True, **kwargs):
    ...
    if os.environ.get("HF_OFFLINE") == "1" or os.environ.get("TRANSFORMERS_OFFLINE") == "1":
    ...
    _wrap_apply_chat_template_disable_thinking(tokenizer)
...
def hf_processor(name_or_path, **kwargs):
    ...
    if processor is not None and "Processor" not in processor.__class__.__name__:
        processor = None
    _wrap_apply_chat_template_disable_thinking(processor)
    return processor
